...
export default async function MembershipPage({
  ...
  const kidPlans = [
    ...
    { label: `${dict.membership.quarter} (2.9 — 31.12.2026)`, price: 290 },
    { label: `${dict.membership.quarter} (6.1 — 31.3.2027)`, price: 225 },
    { label: `${dict.membership.quarter} (1.4 — 30.6.2027)`, price: 225 },
  ]
